...
function PricesTable() {
	...
	const [selectedFilters, setSelectedFilters] = useState({
		region: tsmOptions.region ? tsmOptions.region : null,
		realm: null,
		auctionHouse: null,
	});
	...
	const onChangeRegion = (id) => {
		...
		dispatch(setTSMOptions({ region: regionsWithRealms[id] }));
	};
	...
	const onChangeRealm = (id) => {
		...
		dispatch(setTSMOptions({ realm: realmOptions[id] }));
	};
	...
	const onChangeAuctionHouse = (id) => {
		...
		dispatch(setTSMOptions({ auctionHouse: auctionHouseOptions[id] }));
	};
